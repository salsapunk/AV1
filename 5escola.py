...
def escola(n): #define a função
    if n>2000: #se a quantidade for maior que 2000, executa:
        ...
        for i in range(n): #laço de repetição que se repete na quantidade de alunos
            nota_individual = int(input(f'Digite a nota do aluno {i+1}: ')) #pega o input da nota individual
        ...
        media = (dividendo/n) #define a média como o dividendo dividido pela quantidade de alunos
